...
Celular::Celular(string modelo, string fabricante, int armazenamento, int memoria, double peso, string cor, int qtd, float valor){
    _modelo = modelo;
...
Dado que, por ser um TAD, não há lógica de operação definida como nos Tipos Primitivos*/
