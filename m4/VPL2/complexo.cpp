...
double Complexo::real() const { return this->real_; }

double Complexo::imag() const { return this->imag_; }
...
Complexo Complexo::operator-(Complexo y) const { return (*this) + -y; }
...
Complexo Complexo::operator/(Complexo y) const {
  Complexo i;
  i.real_ = (this->real_ * y.real_ + this->imag_ * y.imag_) /
            (pow(y.real_, 2) + pow(y.imag_, 2));
  i.imag_ = (y.real_ * this->imag_ - this->real_ * y.imag_) /
            (pow(y.real_, 2) + pow(y.imag_, 2));
  return i;
}
